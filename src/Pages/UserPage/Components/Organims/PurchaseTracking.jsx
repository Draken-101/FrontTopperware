        ...
        <div className='ConfirmOrder'>
            ...
            <div className='Traking'>
                ...
                <span className="IconMargin">
                    <IconTraking src="/assets/Icons/icons8-whatsapp-96.png" /> +52 961 321 4782
                </span>
                ...
                <span className="IconMargin">
                    <IconTraking src="/assets/Icons/icons8-banco-96.png" /> 849203571632
                </span>
                <h2> Paso 3 </h2>
                ...
                <h2> Paso 4 </h2>
                <span className="IconMargin">
                    <IconTraking Width={"5vw"} src="/assets/Icons/icons8-casilla-de-verificación-marcada-100.png" />
                    Disfrute  su compra!!!
                </span><hr />
