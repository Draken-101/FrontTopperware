    ...
    return (
        <div className='ConfirmOrder'>
            ...
            <div className='Order'>
                ...
                <Total Title={"Total de productos"} totalProducts={totalProducts} Color={"rgba(88, 0, 155, 0.899)"} /><hr />
                <Total Title={"Total de compra"} totalProducts={`$${totalPrice}`} Color={"rgba(0, 35, 4, 0.6)"} /><hr />
                <ButtonsOrder PlaceAnOrder={PlaceAnOrder} Cancelar={Cancelar} />
            </div>
        </div>
    )
}